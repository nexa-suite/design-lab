...
export class NexaEngineeringPage {
  ...
  protected readonly publicApi: readonly PublicApiRow[] = [
    ...
    { name: 'Numeric Stepper', exportName: 'NexaNumericStepper', selector: '<nexa-numeric-stepper>', contract: 'value/model · min · max · step · unit', inputs: 'id · label · value/model · min · max · step · disabled', outputs: 'valueChange(model)', states: 'minimum · middle · maximum · disabled', accessibility: 'Labelled increment/decrement buttons expose quantity and bounds.', tokens: 'control padding · interactive radius', tests: 'clamp / increment', note: 'Quantity changes remain bounded and announced.', icon: 'pi-sliders-h' },

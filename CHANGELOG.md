...
- Replaced seller-side Purchase Orders with Sales Orders.
- Added OKLCH blue scale review and contrast lab.
- Separated workflow, role and cold-chain color semantics.
- Added responsive mobile navigation drawer with focus return.
- Added Angular Material compatibility bench.

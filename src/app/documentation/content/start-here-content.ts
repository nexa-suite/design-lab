...
export const START_HERE_CONTENT: readonly DocumentationPageContent[] = [
  {
    id: 'overview', label: 'Overview', icon: 'pi-th-large', group: 'START HERE', kind: 'overview',
            ...
            keywords: ['design system', 'documentation', 'visual evidence', 'v0.9'],
            decision: 'v0.9 hardens the evidence-first lab with feature boundaries, truthful state semantics and interaction gates.',
